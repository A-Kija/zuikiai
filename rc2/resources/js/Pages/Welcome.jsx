                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            ...
                            >
                                <div>
                                    ...
                                    <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                        Our colors are bluish, our logo is red, and our documentation is thorough. If
                                        you're looking to get started with Laravel, check out the documentation.
                                    </p>
                                </div>
                            ...
                            >
                                <div>
                                    ...
                                    <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                        We have very fancy and very expensive television commercials. We also have
                                        a lot of animals in our office. But most importantly, we have over 2,000
                                        video lessons on Laravel, PHP, JavaScript, and more.
                                    </p>
                                </div>
